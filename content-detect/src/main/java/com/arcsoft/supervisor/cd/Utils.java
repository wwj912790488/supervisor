...
import com.arcsoft.supervisor.cd.data.DetectResultInfo;
...
public class Utils {
	...
	public static void convertDetectTypeToCheckType(DetectResultInfo detectInfo, CheckResultInfo checkInfo) {
		int value = detctTypeToCheckType(detectInfo.getCheckType());
		checkInfo.setCheckType(value);
		checkInfo.setEndTime(detectInfo.getEndTime());
		checkInfo.setResultId(detectInfo.getResultId());
		checkInfo.setStartTime(detectInfo.getStartTime());
		checkInfo.setTaskid(detectInfo.getTaskid());
		checkInfo.setValue1(detectInfo.getValue1());
		checkInfo.setValue2(detectInfo.getValue2());
		checkInfo.setChannel(detectInfo.getChannel());
	}
}
