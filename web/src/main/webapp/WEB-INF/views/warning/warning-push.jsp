...
<div class="maindiv">
    ...
    <div class="container">
        ...
        <%--<p:profiles hasProfiles="${_profile_sms},${_profile_voice}">
        ...
        <div id="voice-content" class="warning-content">
            <form id="voice-form" class="form">
                <p>
                    ...
                    <input type="text" id="ip" name="ip" class="input" placeholder="111.111.111.111:8080"
                           value="${cfg.ip}" tip-gravity="w">
                </p>

                <div class="text-ct">
                    <div id="down-voice-btn" class="dialog-btn">
                        <a href="/warning/downVoice"> <span class="btn-left"></span><span class="btn-middle">
